...
//			);
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( 'learndash_notifications_admin_scripts', LEARNDASH_NOTIFICATIONS_PLUGIN_URL . 'assets/js/admin-scripts.js', array( 'jquery', 'learndash-select2-jquery-script' ), LEARNDASH_NOTIFICATIONS_VERSION, false );
		...
		wp_localize_script( 'learndash_notifications_admin_scripts', 'LD_Notifications_String', array(
			...
			'select_group'       => __( '-- Select Group --', 'learndash-notifications' ),
			'select_course'       => __( '-- Select Course --', 'learndash-notifications' ),
